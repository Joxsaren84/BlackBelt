package ru.joxaren.streams.sorted;
...
public class TestSorted {
    ...
    public static void main(String[] args) {
        ...
        int [] array = {256, 2, 8, 32, 16, 4, 128, 64};
        ...
        list = list.stream().sorted((s1, s2) -> s1.getName().compareTo(s2.getName())).collect(Collectors.toList());
